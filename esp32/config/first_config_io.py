...
class FirstConfig(UserConfig):
    """
    Using a subclass for the first configuration, so the code does not 
    make the UserConfig itself heavy/loading long at every start.
    """
